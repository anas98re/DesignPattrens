...
// |                                                     |
// +-------------------+                  +---------------------------+
// |     TextInput     |                  |        TextFormat         | (Basic Decorator)
// +-------------------+                  +---------------------------+
// | + formatText(text):str |              | - inputFormat: InputFormat |
// +-------------------+                  | + formatText(text):str      |
//                    +---------------------------+
//                              ^
//                              |
// +----------------------------+    +-----------------------------+    +-----------------------------+
// |      PlainTextFilter       |    | DangerousHTMLTagsFilter     |    |      MarkdownFormat         |
// +----------------------------+    +-----------------------------+    +-----------------------------+
// | + formatText(text):str     |    | + formatText(text):str      |    | + formatText(text):str      |
// +----------------------------+    +-----------------------------+    +-----------------------------+
// |                            |    | - dangerousTagPatterns      |    |                             |
// |                            |    | - dangerousAttributes       |    |                             |
// +----------------------------+    +-----------------------------+    +-----------------------------+
// (Concrete Decorator)               (Concrete Decorator)              (Concrete Decorator)
