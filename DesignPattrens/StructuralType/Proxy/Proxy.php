...
// There are countless ways proxies can be used: caching, 
// logging, access control, delayed initialization, etc. 
// This example demonstrates how the Proxy pattern can improve 
// the performance of a downloader object by caching its results.
...
//             v                                      |
// +-----------------------+                +---------------------------+
// |  CachingDownloader    |----------------|       SimpleDownloader     |
// +-----------------------+    uses        +---------------------------+
