...
// In this example, the Template Method pattern defines a skeleton of the 
// algorithm of message posting to social networks. Each subclass represents 
// a separate social network and implements all the steps differently, but 
// reuses the base algorithm.
