...
class LinkedPoster extends SocialNetworkPoster
{
...
clientCode(new FacebookPoster('Anas Alrefai','*****'));

echo "\n\n";

echo "Testing ConcreteCreator2:\n";
clientCode(new LinkedPoster("john_smith@example.com", "******"));
